...
import { BriefcaseBusiness, Globe, User, Mail, Phone, MapPin } from 'lucide-react'
      ...
      <div className='flex items-center gap-4'>
        ...
        {data.image && (
          <button
            ...
            className="mt-5 px-4 py-2 bg-red-500 text-white rounded-lg text-sm hover:bg-red-600"
          >
            Remove Image
          </button>
        )}
